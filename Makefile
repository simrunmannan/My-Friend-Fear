...
SOURCES            = main.c myLib.c startscreen.c pausescreen.c losestate.c winstate.c gamestate.c spritesheet.c game.c sound.c Blink.c Umbrella.c city.c rain.c rainSound.c gamestate2.c game2.c ticking.c crack.c city2.c
DKPATH             = /users/enya/Desktop/2261/devkitARM/bin
CCPATH             = /usr/bin
VBASIM             = /usr/bin/open
FIND               = find
COPY               = cp -r
